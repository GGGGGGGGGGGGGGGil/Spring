	...
	<body>
		...
		<form action="/BookStore/book/modify" method="post">
			<table border="1">
				<tr>
					<td>도서번호</td>
					<td><input type="text" name="bookId" value="${books.bookId}" readonly="readonly"></td>
				</tr>
				<tr>
					<td>도서명</td>
				...
				<tr>
					<td>출판사</td>
					<td><input type="text" name="publisher" value="${books.publisher}"></td>
				</tr>
				<tr>
					<td>가격</td>
					<td><input type="number" name="price" value="${books.price}"></td>
				</tr>
				<tr>
